...
SESSION = config("MIIBCgKCAQEAyMEdY1aR+sCR3ZSJrtztKTKqigvO/vBfqACJLZtS7QMgCGXJ6XIR", default=None)
FORCESUB = config("xn_ik", default=None)
AUTH = config("Save_alshehri_bot", default=None, cast=int)
